...
var IconService = /** @class */ (function () {
    ...
    function (type) {
        ...
        if (!inProgress) {
            ...
            inProgress = this._http.get(safeUrl, { responseType: 'text' }).pipe(map(function (literal) { return (__assign({}, icon_1, { icon: literal })); }), tap(function (definition) { return _this.addIcon(definition); }), finalize(function () { return _this._inProgressFetches.delete(type); }), catchError(function () { return of(null); }), share());
